...
export const NAV_CATALOG: NavCatalogItem[] = [
  ...
  { id: 'clients', path: '/clients', label: 'Client List', group: 'Clients', roles: ['Partner', 'Admin', 'Manager', 'Staff', 'Intern', 'HR'], permission: { module: 'clients', action: 'view' } },
  ...
  { id: 'messages', path: '/messages', label: 'Messages', group: 'Team', roles: ['Partner', 'Admin', 'Manager', 'Staff', 'Intern', 'HR', 'Accounts'], permission: { module: 'messages', action: 'view' } },
